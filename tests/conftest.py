...
The package under test lives in src/aibom_guardian, so it is not importable from
...
os.environ["AIBOM_GUARDIAN_CACHE"] = str(Path(__file__).resolve().parent / "fixtures")
